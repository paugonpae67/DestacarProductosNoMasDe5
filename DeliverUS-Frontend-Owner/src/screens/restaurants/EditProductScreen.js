...
export default function EditProductScreen ({ navigation, route }) {
  ...
  const [initialProductValues, setInitialProductValues] = useState({ name: null, description: null, price: null, order: null, productCategoryId: null, availability: null, image: null, destacado: false, timeDestacado: null })
        ...
        <ScrollView>
          <View style={{ alignItems: 'center' }}>
            <View style={{ width: '60%' }}>
              ...
              />
              <TextRegular>Is it destacado?</TextRegular>
                ...
                /><ErrorMessage name={'destacado'} render={msg => <TextError>{msg}</TextError> }/>
